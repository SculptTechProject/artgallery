...
export default function TicketsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      selectedExhibition.capacity !== undefined &&
      selectedExhibition.soldCount !== undefined &&
      selectedExhibition.soldCount >= selectedExhibition.capacity
    ) {
      alert("Ta wystawa jest już wyprzedana.");
      return;
    }
    ...
    <main className="min-h-screen bg-[#050505] text-white pb-20 pt-12">
      <div className="container mx-auto px-4">
        <header className="mb-16 text-center">
          ...
          >
            Zarezerwuj miejsce na nadchodzące wydarzenia i zanurz się w świecie
            nowoczesnej sztuki.
          </motion.p>
        </header>
          ...
          {exhibitions.map((ex, index) => (
            ...
            >
              ...
              <div className="p-8 relative">
                ...
                {ex.capacity !== undefined && ex.soldCount !== undefined && (
                  <div className="mb-4">
                    {ex.soldCount >= ex.capacity ? (
                      ...
                      <div
                        className={`text-sm font-medium mb-2 ${
                          ex.capacity - ex.soldCount < 10
                            ? "text-orange-500"
                            : "text-white/70"
                        }`}
                      >
                        {ex.capacity - ex.soldCount < 10 && (
                          <span className="font-bold">Ostatnie sztuki! </span>
                        )}
                        Dostępne miejsca: {ex.capacity - ex.soldCount} /{" "}
                        {ex.capacity}
                      </div>
                    )}
                    {/* Progress bar */}
                ...
                <button
                  ...
                  disabled={
                    ex.capacity !== undefined &&
                    ex.soldCount !== undefined &&
                    ex.soldCount >= ex.capacity
                  }
              ...
              selectedExhibition.soldCount >= selectedExhibition.capacity ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-white/60">
                    Niestety wszystkie bilety na tę wystawę zostały już
                    wyprzedane.
                  </p>
                </div>
              ) : (
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-white/60 mb-10 leading-relaxed">
                Twój bilet został wstępnie zarezerwowany. Na adres email{" "}
                <span className="text-white font-bold">{purchasedEmail}</span>{" "}
                wysłaliśmy instrukcję płatności. Masz 15 minut na opłacenie.
              </p>
